...
export type ModelOption = "client" | "order" | "transport" | "warehouse" | "route";
...
interface TableForModelProps {
    model: ModelOption;
    data: any[];
}

const TableForModel: React.FC<TableForModelProps> = ({ model, data }) => {
